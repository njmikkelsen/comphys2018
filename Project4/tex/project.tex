...
\begin{figure}
\centering
\includegraphics[scale=0.5]{../output/figures/experiment1/netmagnetisation_1.png}
...
\begin{figure}[h!]
\centering
\includegraphics[scale=0.45]{../output/figures/HeatCapacity_MagneticSusceptibility_TwoByTwo.png}
\end{figure}
